...
const W: Record<string, Record<Locale, string>> = {
  bingo: { en: 'Bingo', es: 'Bingo', fr: 'Bingo', de: 'Bingo', pt: 'Bingo', it: 'Bingo', tr: 'Bingo', nl: 'Bingo' },
  shop: { en: 'Shop', es: 'Tienda', fr: 'Boutique', de: 'Shop', pt: 'Loja', it: 'Negozio', tr: 'Mağaza', nl: 'Winkel' },
  shopResources: {
    en: 'Shop (Resources)', es: 'Tienda (Recursos)', fr: 'Boutique (Ressources)', de: 'Shop (Ressourcen)',
    pt: 'Loja (Recursos)', it: 'Negozio (Risorse)', tr: 'Mağaza (Kaynaklar)', nl: 'Winkel (Grondstoffen)',
  },
  divisionReward: {
    en: 'Division reward', es: 'Recompensa de división', fr: 'Récompense de division', de: 'Divisionsbelohnung',
    pt: 'Recompensa de divisão', it: 'Ricompensa di divisione', tr: 'Lig ödülü', nl: 'Divisiebeloning',
  },
  raids: { en: 'Raids', es: 'Incursiones', fr: 'Raids', de: 'Raids', pt: 'Raides', it: 'Raid', tr: 'Baskınlar', nl: 'Raids' },
  craftLadders: {
    en: 'Crafting, ladders', es: 'Fabricación, escaleras', fr: 'Craft, échelles', de: 'Crafting, Ligas',
    pt: 'Crafting, escadas', it: 'Crafting, scalate', tr: 'Üretim, ligler', nl: 'Crafting, ladders',
  },
  campaignsEtc: {
  ...
  gameAnniversary: {
    en: 'Game anniversary', es: 'Aniversario del juego', fr: 'Anniversaire du jeu', de: 'Spiel-Jubiläum',
    pt: 'Aniversário do jogo', it: 'Anniversario del gioco', tr: 'Oyun yıl dönümü', nl: 'Spelverjaardag',
  },
  ordinal7th: { en: '7th', es: '7.º', fr: '7e', de: '7.', pt: '7.º', it: '7°', tr: '7.', nl: '7e' },
  easterEvent: {
    en: 'Easter event', es: 'Evento de Pascua', fr: 'Événement de Pâques', de: 'Oster-Event',
    pt: 'Evento de Páscoa', it: 'Evento di Pasqua', tr: 'Paskalya etkinliği', nl: 'Paasevenement',
  },
  halloween: { en: 'Halloween', es: 'Halloween', fr: 'Halloween', de: 'Halloween', pt: 'Halloween', it: 'Halloween', tr: 'Halloween', nl: 'Halloween' },
  exactYearUnknown: {
    en: 'exact year unknown', es: 'año exacto desconocido', fr: 'année exacte inconnue', de: 'genaues Jahr unbekannt',
    pt: 'ano exato desconhecido', it: 'anno esatto sconosciuto', tr: 'kesin yıl bilinmiyor', nl: 'exact jaar onbekend',
  },
  christmas: { en: 'Christmas', es: 'Navidad', fr: 'Noël', de: 'Weihnachten', pt: 'Natal', it: 'Natale', tr: 'Noel', nl: 'Kerstmis' },
  christmasEvent: {
    en: 'Christmas event', es: 'Evento de Navidad', fr: 'Événement de Noël', de: 'Weihnachts-Event',
    pt: 'Evento de Natal', it: 'Evento di Natale', tr: 'Noel etkinliği', nl: 'Kerstevenement',
  },
  valentinesEvent: {
    en: "Valentine's Day event", es: 'Evento de San Valentín', fr: 'Événement de la Saint-Valentin', de: 'Valentinstag-Event',
    pt: 'Evento do Dia dos Namorados', it: 'Evento di San Valentino', tr: 'Sevgililer Günü etkinliği', nl: 'Valentijnsdagevenement',
  },
  mysteryEvents: {
    en: 'Mystery events', es: 'Eventos misteriosos', fr: 'Événements mystérieux', de: 'Mystery-Events',
    pt: 'Eventos misteriosos', it: 'Eventi misteriosi', tr: 'Gizem etkinlikleri', nl: 'Mysterie-evenementen',
  },
  winterEvent: {
    en: 'Winter event', es: 'Evento de invierno', fr: 'Événement hivernal', de: 'Winter-Event',
    pt: 'Evento de inverno', it: 'Evento invernale', tr: 'Kış etkinliği', nl: 'Winterevenement',
  },
  mysticEvent: {
    en: 'Mystic event', es: 'Evento místico', fr: 'Événement mystique', de: 'Mystisches Event',
    pt: 'Evento místico', it: 'Evento mistico', tr: 'Mistik etkinlik', nl: 'Mystiek evenement',
  },
  hexCityEvent: {
    en: 'Hex City event', es: 'Evento Hex City', fr: 'Événement Hex City', de: 'Hex-City-Event',
    pt: 'Evento Hex City', it: 'Evento Hex City', tr: 'Hex City etkinliği', nl: 'Hex City-evenement',
  },
  dailyLogin: {
    en: 'Daily login', es: 'Inicio de sesión diario', fr: 'Connexion quotidienne', de: 'Tägliches Einloggen',
    pt: 'Login diário', it: 'Accesso giornaliero', tr: 'Günlük giriş', nl: 'Dagelijkse login',
  },
  currentlyInactive: {
    en: 'currently inactive', es: 'actualmente inactivo', fr: 'actuellement inactif', de: 'derzeit inaktiv',
    pt: 'atualmente inativo', it: 'attualmente inattivo', tr: 'şu anda etkin değil', nl: 'momenteel inactief',
  },
  luckySlotsRoulette: {
    en: 'Lucky Slots roulette', es: 'Ruleta Lucky Slots', fr: 'Roulette Lucky Slots', de: 'Lucky-Slots-Roulette',
    pt: 'Roleta Lucky Slots', it: 'Roulette Lucky Slots', tr: 'Lucky Slots ruleti', nl: 'Lucky Slots-roulette',
  },
  mutantPreorder: {
    en: 'Mutant pre-order', es: 'Reserva de mutante', fr: 'Précommande du mutant', de: 'Mutanten-Vorbestellung',
    pt: 'Pré-venda de mutante', it: 'Prenotazione del mutante', tr: 'Mutant ön siparişi', nl: 'Mutant-voorbestelling',
  },
...
function translateWhere(ru: string, locale: Locale): string | null {
  ...
  if (ru === 'Мистический ивент «Weirdtech» 2023') return `${tr('mysticEvent', locale)} «Weirdtech» 2023`
  ...
  if ((m = ru.match(/^Рождественский ивент (\d+)$/))) return `${tr('christmasEvent', locale)} ${m[1]}`
  if ((m = ru.match(/^Ивент ко Дню Св\. Валентина (\d+)$/))) return `${tr('valentinesEvent', locale)} ${m[1]}`
