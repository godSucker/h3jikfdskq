...
export const TYPE_DICT: Record<Locale, Record<string, string>> = {
  ru: TYPE_RU,
  en: {
    Pvp: 'PvP', PVP: 'PvP', Special: 'Special', SPECIAL: 'Special', special: 'Special',
    ZODIAC: 'Zodiac', GACHA: 'Reactor', gacha: 'Reactor', COMMUNITY: 'Community',
    default: 'Basic/Starter', HEROIC: 'Heroic', LEGEND: 'Legendary', RECIPE: 'Secrets',
    SEASONAL: 'Events', VIDEOGAME: 'Video games',
  },
  es: {
    Pvp: 'PvP', PVP: 'PvP', Special: 'Especial', SPECIAL: 'Especial', special: 'Especial',
    ZODIAC: 'Zodiaco', GACHA: 'Reactor', gacha: 'Reactor', COMMUNITY: 'Comunidad',
    default: 'Básico/Inicial', HEROIC: 'Héroes', LEGEND: 'Legendarios', RECIPE: 'Secretos',
    SEASONAL: 'Eventos', VIDEOGAME: 'Videojuegos',
  },
  fr: {
    Pvp: 'PvP', PVP: 'PvP', Special: 'Spécial', SPECIAL: 'Spécial', special: 'Spécial',
    ZODIAC: 'Zodiaque', GACHA: 'Réacteur', gacha: 'Réacteur', COMMUNITY: 'Communauté',
    default: 'Basique/Débutant', HEROIC: 'Héros', LEGEND: 'Légendaires', RECIPE: 'Secrets',
    SEASONAL: 'Événements', VIDEOGAME: 'Jeux vidéo',
  },
}
...
export const ABILITY_DICT: Record<Locale, Record<string, string>> = {
  ru: ABILITY_RU,
  en: {
    ability_shield: 'Shield', ability_shield_plus: 'Shield',
    ability_regen: 'Life Drain', ability_regen_plus: 'Life Drain',
    ability_retaliate: 'Retaliate', ability_retaliate_plus: 'Retaliate',
    ability_slash: 'Wound', ability_slash_plus: 'Wound',
    ability_strengthen: 'Strengthen', ability_strengthen_plus: 'Strengthen',
    ability_weaken: 'Curse', ability_weaken_plus: 'Curse',
  },
  es: {
    ability_shield: 'Escudo', ability_shield_plus: 'Escudo',
    ability_regen: 'Absorción de vida', ability_regen_plus: 'Absorción de vida',
    ability_retaliate: 'Contraataque', ability_retaliate_plus: 'Contraataque',
    ability_slash: 'Herida', ability_slash_plus: 'Herida',
    ability_strengthen: 'Fortalecer', ability_strengthen_plus: 'Fortalecer',
    ability_weaken: 'Maldición', ability_weaken_plus: 'Maldición',
  },
  fr: {
    ability_shield: 'Bouclier', ability_shield_plus: 'Bouclier',
    ability_regen: 'Vol de vie', ability_regen_plus: 'Vol de vie',
    ability_retaliate: 'Répliquer', ability_retaliate_plus: 'Répliquer',
    ability_slash: 'Blessure', ability_slash_plus: 'Blessure',
    ability_strengthen: 'Renforcer', ability_strengthen_plus: 'Renforcer',
    ability_weaken: 'Malédiction', ability_weaken_plus: 'Malédiction',
  },
}
...
const bingoEn: Record<string, string> = {
  hp: 'HP', health: 'HP', atk: 'Attack', attack: 'Attack', attack1: 'Attack 1', attack2: 'Attack 2',
  spd: 'Speed', speed: 'Speed', credit: 'Credits', credits: 'Credits', xp: 'XP',
  gene_a: 'Cyborg', gene_b: 'Undead', gene_c: 'Brawler', gene_d: 'Beast', gene_e: 'Galactic', gene_f: 'Mythic',
  amazons: 'Amazons', anniversary_25: 'Anniversary', anniversary_21: 'Anniversary 2021', anniversary_24: 'Anniversary 2024', anniversary_26: 'Anniversary 2026',
  bingo_bronze: 'Bronze Breeding', bingo_silver: 'Silver Breeding', bingo_gold: 'Gold Breeding', bingo_plat: 'Platinum Breeding',
  cross_mutation: 'Cross-mutation', events: 'Holidays', heroic: 'Heroes', legend: 'Legends', reactor: 'Reactor',
  rumble: 'Rumble', Starter: 'Starter Bingo', starter_plat: 'Platinum Bingo', zodiac: 'Zodiacs', zodiac_silver: 'Silver Zodiacs',
  '10years': '10 Years of the Game',
}
const bingoEs: Record<string, string> = {
  hp: 'PS', health: 'PS', atk: 'Ataque', attack: 'Ataque', attack1: 'Ataque 1', attack2: 'Ataque 2',
  spd: 'Rapidez', speed: 'Rapidez', credit: 'Créditos', credits: 'Créditos', xp: 'XP',
  gene_a: 'Cíborg', gene_b: 'No muerto', gene_c: 'Luchador', gene_d: 'Bestia', gene_e: 'Galáctico', gene_f: 'Mítico',
  amazons: 'Amazonas', anniversary_25: 'Aniversario', anniversary_21: 'Aniversario 2021', anniversary_24: 'Aniversario 2024', anniversary_26: 'Aniversario 2026',
  bingo_bronze: 'Cría de bronce', bingo_silver: 'Cría de plata', bingo_gold: 'Cría de oro', bingo_plat: 'Cría de platino',
  cross_mutation: 'Cruce mutación', events: 'Fiestas', heroic: 'Héroes', legend: 'Leyendas', reactor: 'Reactor',
  rumble: 'Alboroto', Starter: 'Bingo inicial', starter_plat: 'Bingo platino', zodiac: 'Zodiacos', zodiac_silver: 'Zodiacos plata',
  '10years': '10 años del juego',
}
const bingoFr: Record<string, string> = {
  hp: 'PV', health: 'PV', atk: 'Attaque', attack: 'Attaque', attack1: 'Attaque 1', attack2: 'Attaque 2',
  spd: 'Vitesse', speed: 'Vitesse', credit: 'Crédits', credits: 'Crédits', xp: 'XP',
  gene_a: 'Cyborg', gene_b: 'Mort-vivant', gene_c: 'Bagarreur', gene_d: 'Bête', gene_e: 'Galactique', gene_f: 'Mythique',
  amazons: 'Amazones', anniversary_25: 'Anniversaire', anniversary_21: 'Anniversaire 2021', anniversary_24: 'Anniversaire 2024', anniversary_26: 'Anniversaire 2026',
  bingo_bronze: 'Élevage bronze', bingo_silver: 'Élevage argent', bingo_gold: 'Élevage or', bingo_plat: 'Élevage platine',
  cross_mutation: 'Mutation croisée', events: 'Fêtes', heroic: 'Héros', legend: 'Légendes', reactor: 'Réacteur',
  rumble: 'Rumble', Starter: 'Bingo de base', starter_plat: 'Bingo platine', zodiac: 'Zodiaques', zodiac_silver: 'Zodiaques argent',
...
for (let y = 2016; y <= 2026; y++) {
  if (BINGO_RU[`event_${y}`]) {
    bingoEn[`event_${y}`] = `Events ${y}`; bingoEs[`event_${y}`] = `Eventos ${y}`; bingoFr[`event_${y}`] = `Événements ${y}`
  }
  if (BINGO_RU[`event_xmas${y}`]) {
    bingoEn[`event_xmas${y}`] = `Christmas ${y}`; bingoEs[`event_xmas${y}`] = `Navidad ${y}`; bingoFr[`event_xmas${y}`] = `Noël ${y}`
  }
  if (BINGO_RU[`${y}_events`]) {
    bingoEn[`${y}_events`] = `Events ${y}`; bingoEs[`${y}_events`] = `Eventos ${y}`; bingoFr[`${y}_events`] = `Événements ${y}`
  }
  if (BINGO_RU[`${y}_mutants`]) {
    bingoEn[`${y}_mutants`] = `Mutants ${y}`; bingoEs[`${y}_mutants`] = `Mutantes ${y}`; bingoFr[`${y}_mutants`] = `Mutants ${y}`
  }
  if (BINGO_RU[`${y}_skins`]) {
    bingoEn[`${y}_skins`] = `Skins ${y}`; bingoEs[`${y}_skins`] = `Skins ${y}`; bingoFr[`${y}_skins`] = `Skins ${y}`
  }
  if (BINGO_RU[`research_${y - 2015}`] && y - 2015 <= 11) {
    bingoEn[`research_${y - 2015}`] = `Research ${y - 2015}`; bingoEs[`research_${y - 2015}`] = `Investigación ${y - 2015}`; bingoFr[`research_${y - 2015}`] = `Recherche ${y - 2015}`
  }
}
export const BINGO_DICT: Record<Locale, Record<string, string>> = { ru: BINGO_RU, en: bingoEn, es: bingoEs, fr: bingoFr }

export function geneLabelL(code: string, locale: Locale): string {
  if (!code) return ''
  const dict = GENE_DICT[locale] ?? GENE_RU
  return code.toUpperCase().split('').map((ch) => dict[ch] || ch).join('+')
}
