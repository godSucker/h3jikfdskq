...
const GACHA_LABEL: Partial<Record<Locale, string>> = {
  en: 'Reactor', es: 'Reactor', fr: 'Réacteur', de: 'Reaktor', pt: 'Reator', it: 'Reattore', tr: 'Reaktör', nl: 'Reactor',
}
const RAID_LABEL: Partial<Record<Locale, string>> = {
  en: 'Raid', es: 'Incursión', fr: 'Raid', de: 'Überfall', pt: 'Invasão', it: 'Raid', tr: 'Baskın', nl: 'Overval',
}
const LADDER_LABEL: Partial<Record<Locale, string>> = {
  en: 'Ladder', es: 'Escalera', fr: 'Échelle', de: 'Leiter', pt: 'Escada', it: 'Scala', tr: 'Merdiven', nl: 'Ladder',
}
const PIT_LABEL: Partial<Record<Locale, string>> = {
  en: 'Pit', es: 'Pozo', fr: 'Fosse', de: 'Grube', pt: 'Fosso', it: 'Fossa', tr: 'Çukur', nl: 'Kuil',
}

const GACHA_NAME_DICT: Record<string, Partial<Record<Locale, string>>> = {
  'Боги арены': { en: 'Gods of the Arena', es: 'Dioses de la arena', fr: "Dieux de l'arène", de: 'Götter der Arena', pt: 'Deuses da arena', it: "Dei dell'arena", tr: 'Arena Tanrıları', nl: 'Goden van de arena' },
  'Большой босс': { en: 'Big Boss', es: 'Gran jefe', fr: 'Big Boss', de: 'Big Boss', pt: 'Grande chefe', it: 'Grande capo', tr: 'Büyük Patron', nl: 'Grote baas' },
  Вестерн: { en: 'Western', es: 'Western', fr: 'Western', de: 'Western', pt: 'Faroeste', it: 'Western', tr: 'Vahşi Batı', nl: 'Western' },
  Готика: { en: 'Gothic', es: 'Gótico', fr: 'Gothique', de: 'Gotik', pt: 'Gótico', it: 'Gotico', tr: 'Gotik', nl: 'Gothic' },
  Диско: { en: 'Disco', es: 'Disco', fr: 'Disco', de: 'Disco', pt: 'Disco', it: 'Disco', tr: 'Disko', nl: 'Disco' },
  Кино: { en: 'Cinema', es: 'Cine', fr: 'Cinéma', de: 'Kino', pt: 'Cinema', it: 'Cinema', tr: 'Sinema', nl: 'Bioscoop' },
  'Команда элементалей': { en: 'Elemental Team', es: 'Equipo elemental', fr: 'Équipe élémentaire', de: 'Elementar-Team', pt: 'Time elemental', it: 'Squadra elementale', tr: 'Element Takımı', nl: 'Elementair team' },
  'Космические войны': { en: 'Space Wars', es: 'Guerras espaciales', fr: "Guerres de l'espace", de: 'Weltraumkriege', pt: 'Guerras espaciais', it: 'Guerre spaziali', tr: 'Uzay Savaşları', nl: 'Ruimteoorlogen' },
  'Кровавые игры': { en: 'Blood Games', es: 'Juegos de sangre', fr: 'Jeux de sang', de: 'Blutspiele', pt: 'Jogos de sangue', it: 'Giochi di sangue', tr: 'Kan Oyunları', nl: 'Bloedspelen' },
  "Мучачо's": { en: "Muchacho's", es: "Muchacho's", fr: "Muchacho's", de: "Muchacho's", pt: "Muchacho's", it: "Muchacho's", tr: "Muchacho's", nl: "Muchacho's" },
  'Патруль времени': { en: 'Time Patrol', es: 'Patrulla del tiempo', fr: 'Patrouille temporelle', de: 'Zeitpatrouille', pt: 'Patrulha do tempo', it: 'Pattuglia del tempo', tr: 'Zaman Devriyesi', nl: 'Tijdpatrouille' },
  Самоцветы: { en: 'Gems', es: 'Gemas', fr: 'Gemmes', de: 'Edelsteine', pt: 'Gemas', it: 'Gemme', tr: 'Değerli Taşlar', nl: 'Edelstenen' },
  Стимпанк: { en: 'Steampunk', es: 'Steampunk', fr: 'Steampunk', de: 'Steampunk', pt: 'Steampunk', it: 'Steampunk', tr: 'Steampunk', nl: 'Steampunk' },
  'Супер злодеи': { en: 'Super Villains', es: 'Supervillanos', fr: 'Super-vilains', de: 'Superschurken', pt: 'Supervilões', it: 'Super cattivi', tr: 'Süper Kötüler', nl: 'Superschurken' },
  Супергерои: { en: 'Superheroes', es: 'Superhéroes', fr: 'Super-héros', de: 'Superhelden', pt: 'Super-heróis', it: 'Supereroi', tr: 'Süper Kahramanlar', nl: 'Superhelden' },
  'Темное фентези': { en: 'Dark Fantasy', es: 'Fantasía oscura', fr: 'Fantasy sombre', de: 'Dark Fantasy', pt: 'Fantasia sombria', it: 'Fantasy oscuro', tr: 'Karanlık Fantezi', nl: 'Dark Fantasy' },
  'Тропическое лето': { en: 'Tropical Summer', es: 'Verano tropical', fr: 'Été tropical', de: 'Tropischer Sommer', pt: 'Verão tropical', it: 'Estate tropicale', tr: 'Tropik Yaz', nl: 'Tropische zomer' },
  Фотосинтез: { en: 'Photosynthesis', es: 'Fotosíntesis', fr: 'Photosynthèse', de: 'Photosynthese', pt: 'Fotossíntese', it: 'Fotosintesi', tr: 'Fotosentez', nl: 'Fotosynthese' },
  Хищницы: { en: 'Huntresses', es: 'Cazadoras', fr: 'Chasseuses', de: 'Jägerinnen', pt: 'Caçadoras', it: 'Cacciatrici', tr: 'Avcı Kadınlar', nl: 'Jaagsters' },
  Шахматы: { en: 'Chess', es: 'Ajedrez', fr: 'Échecs', de: 'Schach', pt: 'Xadrez', it: 'Scacchi', tr: 'Satranç', nl: 'Schaak' },
  Япония: { en: 'Japan', es: 'Japón', fr: 'Japon', de: 'Japan', pt: 'Japão', it: 'Giappone', tr: 'Japonya', nl: 'Japan' },
}

const RAID_NAME_DICT: Record<string, Partial<Record<Locale, string>>> = {
  'Jungle Bells 1': { en: 'Jungle Bells 1', es: 'Jungle Bells 1', fr: 'Jungle Bells 1', de: 'Jungle Bells 1', pt: 'Jungle Bells 1', it: 'Jungle Bells 1', tr: 'Jungle Bells 1', nl: 'Jungle Bells 1' },
  'Jungle Bells 2': { en: 'Jungle Bells 2', es: 'Jungle Bells 2', fr: 'Jungle Bells 2', de: 'Jungle Bells 2', pt: 'Jungle Bells 2', it: 'Jungle Bells 2', tr: 'Jungle Bells 2', nl: 'Jungle Bells 2' },
  'Jungle Bells 3': { en: 'Jungle Bells 3', es: 'Jungle Bells 3', fr: 'Jungle Bells 3', de: 'Jungle Bells 3', pt: 'Jungle Bells 3', it: 'Jungle Bells 3', tr: 'Jungle Bells 3', nl: 'Jungle Bells 3' },
  Uprising: { en: 'Uprising', es: 'Uprising', fr: 'Uprising', de: 'Uprising', pt: 'Uprising', it: 'Uprising', tr: 'Uprising', nl: 'Uprising' },
  'Адское пламя': { en: 'Hellfire', es: 'Fuego infernal', fr: "Feu de l'enfer", de: 'Höllenfeuer', pt: 'Fogo infernal', it: 'Fuoco infernale', tr: 'Cehennem Ateşi', nl: 'Hellevuur' },
  Амазонка: { en: 'Amazon', es: 'Amazona', fr: 'Amazone', de: 'Amazone', pt: 'Amazona', it: 'Amazzone', tr: 'Amazon', nl: 'Amazone' },
  Антарктика: { en: 'Antarctica', es: 'Antártida', fr: 'Antarctique', de: 'Antarktis', pt: 'Antártida', it: 'Antartide', tr: 'Antarktika', nl: 'Antarctica' },
  Вегас: { en: 'Vegas', es: 'Vegas', fr: 'Vegas', de: 'Vegas', pt: 'Vegas', it: 'Vegas', tr: 'Vegas', nl: 'Vegas' },
  Гиперборея: { en: 'Hyperborea', es: 'Hiperbórea', fr: 'Hyperborée', de: 'Hyperborea', pt: 'Hiperbórea', it: 'Iperborea', tr: 'Hiperborea', nl: 'Hyperborea' },
  'Гора Олимп': { en: 'Mount Olympus', es: 'Monte Olimpo', fr: "Mont Olympe", de: 'Olymp', pt: 'Monte Olimpo', it: 'Monte Olimpo', tr: 'Olimpos Dağı', nl: 'Olympusberg' },
  Колизей: { en: 'Colosseum', es: 'Coliseo', fr: 'Colisée', de: 'Kolosseum', pt: 'Coliseu', it: 'Colosseo', tr: 'Kolezyum', nl: 'Colosseum' },
  Космопорт: { en: 'Spaceport', es: 'Puerto espacial', fr: 'Spatioport', de: 'Weltraumhafen', pt: 'Porto espacial', it: 'Spazioporto', tr: 'Uzay Limanı', nl: 'Ruimtehaven' },
  'Кошмар Хеллоуина': { en: 'Halloween Nightmare', es: 'Pesadilla de Halloween', fr: "Cauchemar d'Halloween", de: 'Halloween-Albtraum', pt: 'Pesadelo de Halloween', it: 'Incubo di Halloween', tr: 'Cadılar Bayramı Kâbusu', nl: 'Halloween Nachtmerrie' },
  Кризис: { en: 'Crisis', es: 'Crisis', fr: 'Crise', de: 'Krise', pt: 'Crise', it: 'Crisi', tr: 'Kriz', nl: 'Crisis' },
  Луна: { en: 'Moon', es: 'Luna', fr: 'Lune', de: 'Mond', pt: 'Lua', it: 'Luna', tr: 'Ay', nl: 'Maan' },
  Марс: { en: 'Mars', es: 'Marte', fr: 'Mars', de: 'Mars', pt: 'Marte', it: 'Marte', tr: 'Mars', nl: 'Mars' },
  'Небесное тело': { en: 'Celestial Body', es: 'Cuerpo celeste', fr: 'Corps céleste', de: 'Himmelskörper', pt: 'Corpo celeste', it: 'Corpo celeste', tr: 'Gök Cismi', nl: 'Hemellichaam' },
  Неон: { en: 'Neon', es: 'Neón', fr: 'Néon', de: 'Neon', pt: 'Néon', it: 'Neon', tr: 'Neon', nl: 'Neon' },
  'Первый эксперимент': { en: 'First Experiment', es: 'Primer experimento', fr: 'Première expérience', de: 'Erstes Experiment', pt: 'Primeiro experimento', it: 'Primo esperimento', tr: 'İlk Deney', nl: 'Eerste experiment' },
  'Пляжные бои Майами': { en: 'Miami Beach Battles', es: 'Batallas en la playa de Miami', fr: 'Batailles sur la plage de Miami', de: 'Miami-Beach-Kämpfe', pt: 'Batalhas na praia de Miami', it: 'Battaglie sulla spiaggia di Miami', tr: 'Miami Sahil Savaşları', nl: 'Miami Beach Gevechten' },
  'Рапа-Нуи': { en: 'Rapa Nui', es: 'Rapa Nui', fr: 'Rapa Nui', de: 'Rapa Nui', pt: 'Rapa Nui', it: 'Rapa Nui', tr: 'Rapa Nui', nl: 'Rapa Nui' },
  'Темный город': { en: 'Dark City', es: 'Ciudad oscura', fr: 'Ville sombre', de: 'Dunkle Stadt', pt: 'Cidade sombria', it: 'Città oscura', tr: 'Karanlık Şehir', nl: 'Duistere stad' },
  Япония: { en: 'Japan', es: 'Japón', fr: 'Japon', de: 'Japan', pt: 'Japão', it: 'Giappone', tr: 'Japonya', nl: 'Japan' },
  Архитектура: { en: 'Architecture', es: 'Arquitectura', fr: 'Architecture', de: 'Architektur', pt: 'Arquitetura', it: 'Architettura', tr: 'Mimari', nl: 'Architectuur' },
  Астероиды: { en: 'Asteroids', es: 'Asteroides', fr: 'Astéroïdes', de: 'Asteroiden', pt: 'Asteroides', it: 'Asteroidi', tr: 'Asteroitler', nl: 'Asteroïden' },
  Бездна: { en: 'Abyss', es: 'Abismo', fr: 'Abysse', de: 'Abgrund', pt: 'Abismo', it: 'Abisso', tr: 'Uçurum', nl: 'Afgrond' },
  'Безумие II': { en: 'Madness II', es: 'Locura II', fr: 'Folie II', de: 'Wahnsinn II', pt: 'Loucura II', it: 'Follia II', tr: 'Çılgınlık II', nl: 'Waanzin II' },
  'Библиотека II': { en: 'Library II', es: 'Biblioteca II', fr: 'Bibliothèque II', de: 'Bibliothek II', pt: 'Biblioteca II', it: 'Biblioteca II', tr: 'Kütüphane II', nl: 'Bibliotheek II' },
  'Верн II': { en: 'Verne II', es: 'Verne II', fr: 'Verne II', de: 'Verne II', pt: 'Verne II', it: 'Verne II', tr: 'Verne II', nl: 'Verne II' },
  'Вечные пески': { en: 'Everlasting Sands', es: 'Arenas eternas', fr: 'Sables éternels', de: 'Ewige Sande', pt: 'Areias eternas', it: 'Sabbie eterne', tr: 'Sonsuz Kumlar', nl: 'Eeuwige zanden' },
  'Дюма II': { en: 'Dumas II', es: 'Dumas II', fr: 'Dumas II', de: 'Dumas II', pt: 'Dumas II', it: 'Dumas II', tr: 'Dumas II', nl: 'Dumas II' },
  'Инферно II': { en: 'Inferno II', es: 'Infierno II', fr: 'Enfer II', de: 'Inferno II', pt: 'Inferno II', it: 'Inferno II', tr: 'Cehennem II', nl: 'Inferno II' },
  'Калевала II': { en: 'Kalevala II', es: 'Kalevala II', fr: 'Kalevala II', de: 'Kalevala II', pt: 'Kalevala II', it: 'Kalevala II', tr: 'Kalevala II', nl: 'Kalevala II' },
  'Криптид II': { en: 'Cryptid II', es: 'Críptido II', fr: 'Cryptide II', de: 'Kryptid II', pt: 'Críptico II', it: 'Criptide II', tr: 'Kriptid II', nl: 'Cryptide II' },
  Мафия: { en: 'Mafia', es: 'Mafia', fr: 'Mafia', de: 'Mafia', pt: 'Máfia', it: 'Mafia', tr: 'Mafya', nl: 'Maffia' },
  'Мусаси II': { en: 'Musashi II', es: 'Musashi II', fr: 'Musashi II', de: 'Musashi II', pt: 'Musashi II', it: 'Musashi II', tr: 'Musashi II', nl: 'Musashi II' },
  'Немертвые II': { en: 'Undying II', es: 'Los No Muertos II', fr: 'Morts-vivants II', de: 'Untote II', pt: 'Não-mortos II', it: 'Non Morti II', tr: 'Ölümsüzler II', nl: 'Ondoden II' },
  Пираты: { en: 'Pirates', es: 'Piratas', fr: 'Pirates', de: 'Piraten', pt: 'Piratas', it: 'Pirati', tr: 'Korsanlar', nl: 'Piraten' },
  'Фабрика II': { en: 'Factory II', es: 'Fábrica II', fr: 'Usine II', de: 'Fabrik II', pt: 'Fábrica II', it: 'Fabbrica II', tr: 'Fabrika II', nl: 'Fabriek II' },
}
...
export function renderObtainWhere(
  ...
  if (entry.type === 'event_raid') {
    ...
    if (!m) return entry.where
    const label = (m[1] === 'Рейд' ? RAID_LABEL : LADDER_LABEL)[locale] ?? (m[1] === 'Рейд' ? RAID_LABEL : LADDER_LABEL).en
    if (!label) return entry.where
