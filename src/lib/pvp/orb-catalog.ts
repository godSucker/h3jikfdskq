...
const CAT_LABELS_DICT: Partial<Record<Locale, Record<string, string>>> = {
  ...
  fr: {
    ...
    xp: 'XP',
    shield: 'Bouclier',
    regenerate: 'Vol de Vie',
    retaliate: 'Contre-attaque',
    slash: 'Blessure',
    strengthen: 'Boost',
    weaken: 'Malédiction',
  },
  de: {
    ...
    xp: 'XP',
    shield: 'Schild',
    regenerate: 'Leben aussaugen',
    retaliate: 'Gegenschlag',
    slash: 'Blessur',
    strengthen: 'Booster',
    weaken: 'Fluch',
  },
  ...
  it: {
    ...
    xp: 'XP',
    shield: 'Scudo',
    regenerate: 'Furto di Vita',
    retaliate: 'Rappresaglia',
    slash: 'Ferita',
    strengthen: 'Potenziamento',
    weaken: 'Maledizione',
  },
  tr: {
    attack: 'Saldırı',
  ...
  nl: {
    ...
    xp: 'XP',
    shield: 'Schild',
    regenerate: 'Levensroof',
    retaliate: 'Vergelding',
    slash: 'Verwonding',
    strengthen: 'Boost',
    weaken: 'Vloek',
  },
