...
export const OBTAIN_SOURCE_LABEL: Record<string, Record<Locale, string>> = {
  ...
  mystery_hall: {
    ru: 'Анализатор тайн',
    en: 'Mystery Analyzer',
    es: 'Analizador de misterios',
    fr: 'Analyseur de mystères',
    de: 'Mysterienanalysator',
    pt: 'Analisador de mistérios',
    it: 'Analizzatore di misteri',
    tr: 'Gizem Analizörü',
    nl: 'Mysterie-analysator',
  },
  bingo: {
    ru: 'Бинго',
    en: 'Bingo',
...
export const OBTAIN_SOURCE_GROUPS: string[][] = [
  ...
  ['jackpot_hall', 'event_hall', 'mystery_hall'],
