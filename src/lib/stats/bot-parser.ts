...
Сравнение двух - через "vs"/"против". До 5 - начни с ".сравнение".
...
// everyone else.
export const ADMIN_FORMAT_HELP = `Админ-команды:
...
.бан / .разбан  - ответом на сообщение юзера, блокировка без срока

Доступ: STATS_BOT_ADMIN_USER_IDS или админ-чат.`
