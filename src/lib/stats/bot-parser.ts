...
export const FORMAT_HELP = `Формат сообщения (свободный порядок слов):
...
Сферы - пиши название категории + процент вплотную рядом, например:
"щит 20%", "атака 12%", "здоровье 25%", "спец щит 20%" (спец-слот - добавь слово "спец")
